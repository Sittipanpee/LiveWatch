...
export const dict = {
  ...
  nav: {
    ...
    sessions: { th: 'ประวัติไลฟ์', en: 'Session History' },
  },
  landing: {
  ...
  sessions: {
    title: { th: 'ประวัติไลฟ์', en: 'Session History' },
    empty: { th: 'ยังไม่มีข้อมูลไลฟ์', en: 'No live sessions recorded yet' },
    emptyHint: { th: 'เริ่มไลฟ์บน TikTok เพื่อเริ่มบันทึก', en: 'Go live on TikTok to start recording' },
    started: { th: 'เริ่มเมื่อ', en: 'Started' },
    duration: { th: 'ระยะเวลา', en: 'Duration' },
    bursts: { th: 'รอบวิเคราะห์', en: 'Bursts' },
    alerts: { th: 'แจ้งเตือน', en: 'Alerts' },
    view: { th: 'ดูรายละเอียด', en: 'View' },
    viewAll: { th: 'ดูทั้งหมด →', en: 'View all →' },
    recentSessions: { th: 'ไลฟ์ล่าสุด', en: 'Recent Sessions' },
    mins: { th: 'นาที', en: 'min' },
    noUrl: { th: 'ไม่มี URL', en: 'No URL' },
    back: { th: '← กลับไปยังรายการ', en: '← Back to sessions' },
    detailTitle: { th: 'รายละเอียดไลฟ์', en: 'Session Detail' },
    ended: { th: 'สิ้นสุดเมื่อ', en: 'Ended' },
    ongoing: { th: 'กำลังไลฟ์อยู่', en: 'Ongoing' },
    totalBursts: { th: 'รอบทั้งหมด', en: 'Total Bursts' },
    totalAlerts: { th: 'แจ้งเตือนทั้งหมด', en: 'Total Alerts' },
    avgEyeContact: { th: 'สายตาเฉลี่ย', en: 'Avg Eye Contact' },
    avgSmile: { th: 'รอยยิ้มเฉลี่ย', en: 'Avg Smile' },
    capturedAt: { th: 'เวลาที่จับภาพ', en: 'Captured at' },
    eyeContact: { th: 'สายตา', en: 'Eye Contact' },
    smile: { th: 'รอยยิ้ม', en: 'Smile' },
    phone: { th: 'โทรศัพท์', en: 'Phone' },
    alert: { th: 'แจ้งเตือน', en: 'Alert' },
    product: { th: 'นำเสนอสินค้า', en: 'Product' },
    noFrames: { th: 'ยังไม่มีข้อมูลการวิเคราะห์', en: 'No analysis frames yet' },
